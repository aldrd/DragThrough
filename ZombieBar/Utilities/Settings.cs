...
namespace ZombieBar.Utilities
{
    public class Settings : INotifyPropertyChanged
    {
        ...
        // Whether the additional taskbar window is shown. Toggled by the taskbar's "Remove" item
        // and the tray menu's "Show taskbar" item.
        public bool ShowAdditionalTaskbar
        {
            get { return settings.ShowAdditionalTaskbar; }
            set { if (settings.ShowAdditionalTaskbar != value) settings.ShowAdditionalTaskbar = value; }
        }

        #region DragThrough (temporarily hide Explorer while dragging files)
        public bool EnableWindowsKeyModifier
        {
            get { return settings.EnableWindowsKeyModifier; }
            set { if (settings.EnableWindowsKeyModifier != value) settings.EnableWindowsKeyModifier = value; }
        }

        public bool EnableShiftModifier
        {
            get { return settings.EnableShiftModifier; }
            set { if (settings.EnableShiftModifier != value) settings.EnableShiftModifier = value; }
        }

        public bool MinimizeExplorerAfterSuccessfulDrag
        {
            get { return settings.MinimizeExplorerAfterSuccessfulDrag; }
            set { if (settings.MinimizeExplorerAfterSuccessfulDrag != value) settings.MinimizeExplorerAfterSuccessfulDrag = value; }
        }

        public bool DismissWindowsSearchWithEscape
        {
            get { return settings.DismissWindowsSearchWithEscape; }
