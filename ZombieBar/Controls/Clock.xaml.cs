...
namespace ZombieBar.Controls
{
    ...
    public partial class Clock : UserControl
    {
        ...
        {
            // Subscribe to timer ticks exactly once. StartClock/StopClock only start/stop the timers,
            // otherwise every ShowClock toggle would add another Tick handler (duplicate ticks / leak).
