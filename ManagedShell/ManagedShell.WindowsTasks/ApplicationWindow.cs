...
namespace ManagedShell.WindowsTasks
{
    ...
    public class ApplicationWindow : DisposableViewModelBase, IEquatable<ApplicationWindow>, INotifyPropertyChanged, IDisposable
    {
        ...
        // Order identifier determining this window's position on the taskbar.
        // Assigned and persisted by ZombieBar (keyed on the title the window had when added);
        // an empty value means no order has been assigned yet.
        public string Order
        {
            get { return _order; }
        ...
        public TaskBarDisplayType TaskBarDisplayType
        {
            get
            {
                if (_taskBarDisplayType == null)
                {
                    SetTitleAndTaskBarDisplayType();
                }
                return _taskBarDisplayType.Value;
            }
            set { SetValue(ref _taskBarDisplayType, value); }
        }

        private TaskBarDisplayType? _taskBarDisplayType;
        ...
        private void SetTitleAndTaskBarDisplayType()
        {
            ...
            try
            {
                ...
                TaskBarDisplayType = taskBarDisplayType;
            }
            catch { }
    ...
    public enum TaskBarDisplayType : int
    {
        Left = 0,
        Right = 1
    }
