...
namespace ManagedShell.WindowsTray
{
    public class TrayService : IDisposable
    {
        ...
        // Messages that must be forwarded asynchronously (via PostMessage). Forwarding
        // these synchronously (SendMessage) makes a restarting Explorer crash in a loop
        // on Windows 11. See cairoshell/ManagedShell commit 33dc8a3 (RetroBar #457).
        ...
        private IntPtr ForwardMsg(IntPtr hWnd, int msg, IntPtr wParam, IntPtr lParam)
        {
            ...
            {
                if (Array.IndexOf(ForwardMessagesPost, msg) > -1)
                {
        ...
        private void RegisterTrayWnd()
        {
            ...
            HwndTray = CreateWindowEx(
                ...
                (int)(23 * ScreenHelper.PrimaryScreenScaleX), IntPtr.Zero, IntPtr.Zero, hInstance, IntPtr.Zero);
        ...
        private void RegisterNotifyWnd()
        {
            ...
            HwndNotify = CreateWindowEx(0, trayNotifyClassReg, null,
                ...
                WindowStyles.WS_CLIPSIBLINGS, 0, 0, GetSystemMetrics(0),
                (int)(23 * ScreenHelper.PrimaryScreenScaleX), HwndTray, IntPtr.Zero, hInstance, IntPtr.Zero);
